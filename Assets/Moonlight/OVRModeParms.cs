...
Filename    :   OVRModeParms.cs
Content     :   Example component that can be dropped onto a GameObject to assist
			:	in configuring vr mode parms.
...
#region Member Variables
	...
	/// <summary>
	/// Enable vr mode parm configuration.
	/// </summary>
	void OnEnable() {
#if (UNITY_ANDROID && !UNITY_EDITOR)
		if ( cameraController != null ) {
			cameraController.OnConfigureVrModeParms += ConfigureVrModeParms;
		}
	...
	/// <summary>
	/// Disable vr mode parm configuration.
	/// </summary>
	void OnDisable() {
#if (UNITY_ANDROID && !UNITY_EDITOR)
		if ( cameraController != null ) {
